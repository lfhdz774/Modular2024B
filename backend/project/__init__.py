...
CORS(app, supports_credentials=True, resources={r"/*": {"origins": ["http://localhost:3000", "http://serverportal-app.org:3000"]}})
...
from project.Groups.view import groups_blueprint
